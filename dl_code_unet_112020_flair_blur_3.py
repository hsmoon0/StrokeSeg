...
def cnn(fliter_num,kernel_size):
    ...
    np.save('/home/alex/Stroke/results/train_loss_f_blur_3.npy',train_loss)
    train_acc = history.history['dice_metric']
    np.save('/home/alex/Stroke/results/train_acc_f_blur_3.npy',train_acc)
    val_loss = history.history['val_loss']
    np.save('/home/alex/Stroke/results/val_loss_f_blur_3.npy',val_loss)
    val_acc = history.history['val_dice_metric']
    np.save('/home/alex/Stroke/results/val_acc_f_blur_3.npy',val_acc)

    model.save('/home/alex/Stroke/results/model_f_blur_3.h5')
