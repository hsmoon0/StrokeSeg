...
nonzero1_train = np.transpose(np.nonzero(data_y_1[25*5:25*24,:,:]))
...
nonzero1_test= np.transpose(np.nonzero(data_y_1[0:25*8,:,:]))
...
def cnn(fliter_num,kernel_size):
    ...
    np.save('/home/alex/Stroke/results/train_loss_dw_k3.npy',train_loss)
    train_acc = history.history['dice_metric']
    np.save('/home/alex/Stroke/results/train_acc_dw_k3.npy',train_acc)
    val_loss = history.history['val_loss']
    np.save('/home/alex/Stroke/results/val_loss_dw_k3.npy',val_loss)
    val_acc = history.history['val_dice_metric']
    np.save('/home/alex/Stroke/results/val_acc_dw_k3.npy',val_acc)

    model.save('/home/alex/Stroke/results/model_dw_3.h5')
