...
def data_organizer_random_3d(kfold, nth_fold):
...
def cnn(start_filter_num, filter_size, stride_size, dropout_ratio, kfold, nth_fold):
    with strategy.scope():
        ...
        x_train, y_train, x_val, y_val = data_organizer_random_3d(kfold, nth_fold)
        model.summary()
    ...
    #            print(a)
        ...
        np.save('/home/alex/Stroke_multi/results/train_loss_3d_fold_' + str(nth_fold) + '_1.npy',train_loss)
        train_acc = history.history['dice_metric']
        np.save('/home/alex/Stroke_multi/results/train_acc_3d_fold_' + str(nth_fold) + '_1.npy',train_acc)
        val_loss = history.history['val_loss']
        np.save('/home/alex/Stroke_multi/results/val_loss_3d_fold_' + str(nth_fold) + '_1.npy',val_loss)
        val_acc = history.history['val_dice_metric']
        np.save('/home/alex/Stroke_multi/results/val_acc_3d_fold_' + str(nth_fold) + '_1.npy',val_acc)

        model.save('/home/alex/Stroke_multi/results/model_3d_fold_' + str(nth_fold) + '_1.h5')
        ...
        nib.save(nif_img, '/home/alex/Stroke_multi/results/pred_3d_fold_' + str(nth_fold) + '_1.nii')
