...
def cnn(fliter_num,kernel_size):
    ...
    np.save('/home/alex/Stroke/results/train_acc_mm_14_2.npy',train_acc)
    val_acc = history.history['val_dice_metric']
    np.save('/home/alex/Stroke/results/val_acc_mm_14_2.npy',val_acc)

    model.save('/home/alex/Stroke/results/model_14_2.h5')
